package com.graduationajajat.artiste.config;

import com.graduationajajat.artiste.jwt.JwtAccessDeniedHandler;
import com.graduationajajat.artiste.jwt.JwtAuthenticationEntryPoint;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                .antMatchers("/api/v1/user/admin/signup").permitAll()
